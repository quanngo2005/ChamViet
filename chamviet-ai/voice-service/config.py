...
GEMINI_LLM_MODEL = _env("GEMINI_LLM_MODEL", "models/gemini-2.5-pro")
...
LLM_JUDGE_TEMPERATURE = _env_float("LLM_JUDGE_TEMPERATURE", 0.7)
LLM_JUDGE_MAX_TOKENS = _env_int("LLM_JUDGE_MAX_TOKENS", 220)
...
TTS_LEADING_SILENCE_MS = _env_int("TTS_LEADING_SILENCE_MS", 350)
TTS_TRAILING_SILENCE_MS = _env_int("TTS_TRAILING_SILENCE_MS", 450)
