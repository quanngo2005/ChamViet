...
EMBEDDING_ACCEPT_THRESHOLD = _env_float("EMBEDDING_ACCEPT_THRESHOLD", 0.5)
...
# VAD (Voice Activity Detection) - silence rejection before API call
STT_VAD_ENERGY_THRESHOLD = _env_float("STT_VAD_ENERGY_THRESHOLD", 300.0)
STT_VAD_SPEECH_MIN_DURATION = _env_float("STT_VAD_SPEECH_MIN_DURATION", 0.15)
STT_VAD_SPEECH_RATIO = _env_float("STT_VAD_SPEECH_RATIO", 0.05)
