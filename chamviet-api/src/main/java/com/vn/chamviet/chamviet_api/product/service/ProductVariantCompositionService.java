...
public class ProductVariantCompositionService {
    ...
    public void validateComponents(List<ProductVariantComponent> components) {
        ...
        for (ProductVariantComponent component : components) {
            if (component.getComponentItem() == null) {
            ...
            if (component.getComponentItem().getComponentType() == ComponentItem.ComponentType.PUZZLE) {
                totalPuzzle += component.getQuantity();
            } else if (component.getComponentItem().getComponentType() == ComponentItem.ComponentType.PEPPER_GHOST) {
